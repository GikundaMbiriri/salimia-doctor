                    ...
                    <div class="loader h-100">
                        ...
                        <div class="row">
                            <div class="card-body p-4">
                                ...
                                <form onsubmit="validateForm(event)" id="signIn" novalidate>
                                    <div class="form-group p-1">
                                        <label for="username text-muted">
                                            <h6 class="text-grey"><i class="fas fa-user"></i> Username</h6>
                                        </label>
                                        <input name="username" placeholder="Enter your username" required="true" id="username" type="text" class="form-control"/>
                                        <div class="invalid-feedback">Please enter your username</div>
                                        <label for="password" class="mt-4">
                                            <h6 class="text-grey"><i class="fas fa-key"></i> Password</h6>
                                        </label>
                                        <input name="password" placeholder="Enter your password" required="true" id="password" type="password" class="form-control"/>
